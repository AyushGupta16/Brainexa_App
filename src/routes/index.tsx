...
const REFERRAL = [
  ...
  { icon: BadgePercent, label: "Earn 5% Commission" },
...
const FAQS = [
  ...
  },
  {
    ...
    a: "The premium course is available at a special launch price of just ₹299 (regular price ₹999) — a one-time payment for full course access.",
  },
  {
  ...
  },
  {
    ...
    a: "Login to your dashboard, copy your unique referral link and share it. You'll earn 5% commission on every sale made through your link — with unlimited earning potential.",
  },
];
            ...
            <div className="grid items-center gap-10 md:grid-cols-2">
              ...
              <div className="rounded-3xl bg-white/5 p-6 ring-1 ring-white/10 backdrop-blur-sm sm:p-8">
                <div className="flex items-baseline gap-3">
                  ...
                  <span className="text-xl text-navy-foreground/50 line-through">
                    ₹999
                  </span>
                </div>
                <span className="mt-3 inline-flex rounded-full bg-emerald/20 px-3 py-1 text-xs font-bold uppercase tracking-wider text-emerald">
                  Save 70%
                </span>
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gradient-navy p-8 shadow-elevated sm:p-12">
              ...
              <div className="relative grid gap-10 lg:grid-cols-2 lg:items-center">
                <div>
                  ...
                  <p className="mt-3 text-base leading-relaxed text-navy-foreground/75">
                    Invite your friends to Brainexa and earn 5% commission on
                    every sale through your referral link.
                  </p>
